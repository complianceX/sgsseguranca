...
export const APR_DOCUMENT_RISK_LEVELS: AprDocumentRiskLevelStyle[] = [
  ...
  },
  {
    ...
    label: "Baixo",
    tone: "bg-ds-success",
    accent: "accent-[var(--ds-color-success)]",
    subtle: "bg-ds-success-subtle text-[var(--ds-color-success-fg)]",
  },
  {
    key: "medio",
    label: "Médio",
    tone: "bg-ds-warning",
    accent: "accent-[var(--ds-color-warning)]",
    subtle: "bg-ds-warning-subtle text-[var(--ds-color-warning-fg)]",
  },
  {
    key: "alto",
    label: "Alto",
    tone: "bg-[var(--ds-color-elevated)]",
    accent: "accent-[var(--ds-color-elevated)]",
    subtle: "bg-[var(--ds-color-elevated-subtle)] text-[var(--ds-color-elevated-fg)]",
  },
  {
    key: "critico",
    label: "Crítico",
    tone: "bg-ds-danger",
    accent: "accent-[var(--ds-color-danger)]",
    subtle: "bg-ds-danger-subtle text-[var(--ds-color-danger-fg)]",
  },
];

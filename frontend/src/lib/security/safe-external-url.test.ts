...
describe("safeExternalArtifactUrl", () => {
  ...
  it("permite URLs do app, API configurada, storage governado e blob local", () => {
    ...
    expect(
      safeExternalArtifactUrl("https://s3.us-east-005.backblazeb2.com/Sgs-Seguranca/file.pdf"),
    ).toBe("https://s3.us-east-005.backblazeb2.com/Sgs-Seguranca/file.pdf");

...
export const validationSchema = Joi.object({
  ...
  SIGNATURE_TIMESTAMP_ACTIVE_KEY_ID: Joi.string().optional().allow(''),
  SIGNATURE_TIMESTAMP_ACTIVE_SECRET: Joi.string().optional().allow(''),
  SIGNATURE_TIMESTAMP_VERIFICATION_KEYS_JSON: Joi.string().optional().allow(''),

...
export const PRIVACY_SUBPROCESSORS: PrivacySubprocessor[] = [
  ...
  },
  {
    ...
    category: 'database',
    status: 'active',
    countries: ['Brasil (Sao Paulo, sa-east-1)'],
  ...
  {
    id: 'redis',
    provider: 'Upstash (Redis gerenciado)',
  ...
  },
  {
    id: 'vercel',
    provider: 'Vercel',
    service: 'Hospedagem do frontend (Next.js)',
    category: 'hosting',
    status: 'active',
    countries: ['Estados Unidos'],
    purpose: 'Entrega da aplicacao web, edge e proxy same-origin para a API',
    dataCategories: ['metadados de requisicao', 'logs de edge', 'IP'],
    sensitiveDataRisk: 'medium',
    internationalTransfer: true,
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['DPA vigente', 'regiao de deploy', 'politica de logs'],
  },
  {
    id: 'resend',
    provider: 'Resend',
    service: 'Envio de e-mail transacional',
    category: 'email',
    status: 'configured_if_enabled',
    countries: ['Estados Unidos'],
    purpose:
      'Entrega de e-mails transacionais (credenciais, notificacoes, links)',
    dataCategories: ['e-mail', 'nome', 'conteudo do e-mail'],
    sensitiveDataRisk: 'medium',
    internationalTransfer: true,
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: [
      'DPA vigente',
      'regiao',
      'politica de retencao de e-mail',
    ],
  },
];
